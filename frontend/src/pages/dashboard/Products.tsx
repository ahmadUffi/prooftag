      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500">
            Manage batches and individual product identities
          </p>
        </div>
        <Dialog>
          <DialogTrigger>
                ...
                <Select>
                  ...
                  <SelectContent>
                    <SelectItem value="consumable">
                      Consumable (One-time use / Token)
                    </SelectItem>
                    <SelectItem value="durable">
                      Durable (Ownership / NFT)
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
                          ...
                          <DialogContent className="sm:max-w-md">
                            ...
                            <div className="flex flex-col items-center justify-center p-8 bg-white border rounded-2xl gap-6">
                              <div className="p-4 bg-white border-4 border-slate-900 rounded-xl">
                                <QRCodeSVG
                                  value={`https://shieldtag.io/verify/${selectedProduct.id}`}
                                  size={200}
                                />
                              </div>
              ...
              >
                <CardHeader className="pb-2">
                  ...
                  <CardDescription className="flex items-center gap-2 mt-1">
                    ...
                    {batch.total.toLocaleString()} units
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="w-full bg-slate-100 h-2 rounded-full overflow-hidden">
                      <div
                        ...
                        style={{
                          width: batch.status === "READY" ? "100%" : "65%",
                        }}
                      />
                    </div>
                    <Button
